...
class Product(Base):
    ...
    unit_weight_lbs: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    ...
    daily_demand_signals: Mapped[list["DailyDemandSignal"]] = relationship(back_populates="product")
    risk_incidents: Mapped[list["RiskIncident"]] = relationship(back_populates="product")
